...
def run_learn_mode(exercise: BaseExercise, camera_index: int = 0):
    ...
    run_countdown(cap, detector, window_name, seconds=3, title="Practice starts in")
    ...
    while True:
        ...
        # Prefer exercise feedback; fall back to tip when feedback is neutral
    ...
    print(f"[Learn Mode] Finished practice for {exercise.name}. Reps detected: {exercise.reps}")
